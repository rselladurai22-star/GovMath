    ...
    <CalculatorShell
      ...
      explainer={
        <BlueprintExplainer
          howWeCalculated={
            <p>
              Expected annual prizes = holding × prize fund rate. Prizes are tax-free, so we also show what gross interest you&rsquo;d need in a standard taxable account to match the rate at basic and higher tax rates.
            </p>
          }
          officialRules={
            <ul>
          ...
          pitfalls={[
            { title: "Median return is lower than &lsquo;expected&rsquo;", body: "The rate is an average pulled up by huge jackpots. The typical (median) holder wins less than the headline rate — small holdings often win nothing for months." },
            ...
            { title: "Not inflation-proof", body: "Premium Bonds aren&rsquo;t index-linked. In a 5% inflation year, the &quot;expected&quot; 3.80% prize rate is a real loss." },
          ]}
          faqs={[
