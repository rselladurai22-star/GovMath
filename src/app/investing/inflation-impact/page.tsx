...
export const metadata: Metadata = {
  ...
  description: "See what your savings or investment will really be worth in tomorrow’s money, after UK inflation.",
};
...
export default function InflationPage() {
  return (
    <CalculatorShell
      ...
      intro="£10,000 today won’t buy £10,000 worth of stuff in ten years — inflation chips away at every pound. This shows the real purchasing power of your future money, not just the headline number."
      calculator={<InflationCalculator />}
      explainer={
        <BlueprintExplainer
          howWeCalculated={<p>Nominal future value = present × (1 + nominal)^years. Real future value uses the Fisher equation: (1 + real) = (1 + nominal) ÷ (1 + inflation). The result is in today’s purchasing power.</p>}
          officialRules={
            <ul>
          ...
          pitfalls={[
            { title: "Don’t just subtract", body: "Real rate ≈ nominal − inflation only works for small numbers. Fisher equation is exact: at 10% nominal / 6% inflation, real rate is 3.77%, not 4%." },
            { title: "Cash drag is real", body: "If your easy-access savings pay 3% and CPI is 4%, you’re losing 1% of purchasing power per year — even though the balance goes up." },
          ...
          disclaimer="Educational. Investment returns aren’t guaranteed."
        />
      }
    />
  );
