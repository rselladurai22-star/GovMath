...
export default function FreeChildcareHoursPage() {
  return (
    <CalculatorShell
      ...
      intro="From September 2025 working parents in England can get 30 hours of funded childcare from when their baby is 9 months old. We map your child’s age and your work status to the right entitlement."
      ...
      explainer={
        <BlueprintExplainer
          ...
          pitfalls={[
            ...
            { title: "‘Free’ isn’t always free", body: "Nurseries often add charges for meals, nappies and consumables on top of funded hours. Government rates don’t cover their costs." },
          ...
          faqs={[
            { question: "Can grandparents claim?", answer: "Only if they’re the legal parents/guardians. They can register as informal childcare under Tax-Free Childcare though." },
            ...
            { question: "What if I’m self-employed?", answer: "Self-employed parents qualify on the same earnings basis. First-year start-ups get a 12-month exemption from the minimum earnings test." },
          ]}
          disclaimer="England rules only. Always confirm eligibility on childcarechoices.gov.uk and check your nursery’s funding agreement."
        />
      }
    />
  );
