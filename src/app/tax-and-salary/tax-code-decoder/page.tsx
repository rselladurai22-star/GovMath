...
export const metadata: Metadata = {
  ...
  description: "Type your PAYE tax code and see your personal allowance, what each letter means, and whether you&rsquo;re on an emergency code.",
};
        ...
        <BlueprintExplainer
          howWeCalculated={
            <p>
              ...
              The letter sets the variant (M/N for Marriage Allowance, T for tapered, K for negative allowance). A W1, M1 or X suffix means it&rsquo;s non-cumulative — applied to one pay period at a time.
            </p>
          }
          officialRules={
            <ul>
          ...
          faqs={[
            ...
            { question: "Why is mine 1257L but I&rsquo;m still paying tax?", answer: "1257L gives £12,570 tax-free per year — about £1,048/month. Anything over that is taxed at your marginal rate." },
          ]}
