...
export default function RedundancyPage() {
  return (
    <CalculatorShell
      ...
      intro="If you&rsquo;ve worked somewhere two years or more and your role is being made redundant, you&rsquo;re entitled to a statutory payment. This is the legal minimum — many employers pay more."
      ...
      explainer={
        <BlueprintExplainer
          ...
          officialRules={
            <ul>
              <li>You need at least 2 years&rsquo; continuous service.</li>
              ...
              <li>National Insurance isn&rsquo;t due on statutory redundancy.</li>
            </ul>
          }
          pitfalls={[
            ...
            { title: "Notice pay is separate", body: "You&rsquo;re also entitled to statutory notice (1 week per year of service, capped at 12 weeks) — paid on top." },
            { title: "PILON is taxable", body: "Pay-in-lieu-of-notice is treated as normal earnings — full Income Tax and NI." },
          ]}
          faqs={[
            { question: "What if I&rsquo;m offered alternative employment?", answer: "If suitable and you unreasonably refuse, you may lose redundancy rights. Use the 4-week trial period to test it." },
