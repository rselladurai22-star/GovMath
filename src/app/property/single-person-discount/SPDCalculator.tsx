    ...
    <div className="space-y-6">
      <div className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1.2fr)]">
        <div className="rounded-xl bg-surface border border-border p-6 space-y-5">
          <NumberInput label="Full annual Council Tax bill" value={bill} onChange={setBill} step={50} hint="Before any discount. Check your latest bill or your council&rsquo;s website." />
        </div>
        <div className="rounded-xl bg-white border-2 border-primary p-6 space-y-4">
          <div>
            <p className="text-sm font-semibold text-text/70 uppercase tracking-wide">You&rsquo;d pay</p>
          ...
          />
          <p className="text-xs text-text/60 bg-blue-50 border border-blue-200 rounded p-3">Apply via your local council&rsquo;s website. Discount applies from the date you become the only adult — backdate if you missed it.</p>
        </div>
      </div>
    </div>
  );
