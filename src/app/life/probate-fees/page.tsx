...
export default function ProbateFeesPage() {
  return (
    <CalculatorShell
      ...
      intro="Probate is the legal right to deal with someone&rsquo;s estate after they die. Estates over £5,000 pay a flat £300 application fee — plus £1.50 for each extra sealed copy of the grant."
      calculator={<ProbateFeesCalculator />}
      explainer={
        <BlueprintExplainer
          howWeCalculated={
            <p>
              Estates worth £5,000 or less pay nothing. Above £5,000 it&rsquo;s a flat £300, regardless of estate size.
          ...
          officialRules={
            <ul>
              ...
              <li>Solicitor&rsquo;s own fees are separate and not regulated.</li>
          ...
          pitfalls={[
            ...
            { title: "Joint assets bypass probate", body: "Anything held as joint tenants passes automatically and doesn&rsquo;t count towards the probate threshold." },
          ]}
          faqs={[
