...
export const metadata: Metadata = {
  ...
  description: "Total your allowable expenses using HMRC&rsquo;s simplified flat rates for working from home and mileage, plus itemised categories.",
};
...
export default function AllowableExpensesPage() {
  return (
    <CalculatorShell
      ...
      intro="Every pound of allowable expense knocks ~28p off your tax bill (basic rate + Class 4 NI). We add HMRC&rsquo;s simplified flat rates for home working and mileage to your itemised categories."
      ...
      explainer={
        <BlueprintExplainer
          ...
          disclaimer="Estimates only — HMRC sets the final allowable amount. Get a chartered accountant&rsquo;s view if your trade has unusual costs."
        />
      }
    />
  );
