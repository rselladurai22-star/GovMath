        ...
        <BlueprintExplainer
          ...
          officialRules={
            <ul>
              ...
              <li>‘Limited cost trader’ rate of 16.5% applies if goods cost &lt;2% of turnover (or under £1,000/yr).</li>
            </ul>
          }
          pitfalls={[
            ...
            { title: "Can’t reclaim capital goods", body: "Except items over £2,000 — laptops, machinery, etc." },
            { title: "Charge 20% to customers", body: "Even on FRS, you still invoice 20% VAT. You just keep the difference." },
          ]}
          faqs={[
            { question: "What rate applies to me?", answer: "Look up gov.uk ‘VAT Flat Rate Scheme’. IT consultants 14.5%, journalists 12.5%, hairdressers 13%, etc." },
            { question: "Can I switch later?", answer: "Yes — give 30 days notice. You can’t rejoin within 12 months of leaving." },
          ]}
