...
export default function PaymentOnAccountPage() {
  return (
    <CalculatorShell
      ...
      intro="HMRC charges Self Assessment in three goes: the balancing payment for last year, plus two equal advance &lsquo;payments on account&rsquo; for this year. The January bill is famously double-sized."
      calculator={<PaymentOnAccountCalculator />}
      explainer={
        <BlueprintExplainer
          howWeCalculated={<p>POA = last year&rsquo;s tax bill ÷ 2, due 31 January and 31 July. The 31 January cash demand = balancing payment + first POA — often 1.5–2× what self-employed people expect.</p>}
          officialRules={
            <ul>
          ...
          pitfalls={[
            { title: "First-year shock", body: "Year 1 self-employed: 31 Jan you pay last year&rsquo;s tax + first POA for current year. Save 60% of profits aside, not 30%." },
          ...
          faqs={[
            ...
            { question: "Can I pay early?", answer: "Yes — HMRC credits the account. Saves interest if you&rsquo;ll be late on another deadline." },
          ]}
