...
export default function MileagePage() {
  return (
    <CalculatorShell
      ...
      intro="If you use your own vehicle for work, you can claim a tax-free allowance from your employer — or as an expense if self-employed. HMRC&rsquo;s Approved Mileage Allowance Payments (AMAP) haven&rsquo;t changed since 2011."
      ...
      explainer={
        <BlueprintExplainer
          ...
          pitfalls={[
            { title: "Commuting doesn&rsquo;t count", body: "Home → permanent workplace is private travel. Home → temporary workplace (under 24 months / less than 40% of your time) usually counts." },
            { title: "AMAP rates haven&rsquo;t risen since 2011", body: "Fuel costs have doubled but the 45p rate hasn&rsquo;t budged. Many drivers genuinely lose money — write to your MP." },
          ...
          faqs={[
            { question: "Can I claim instead of taking a company car?", answer: "Yes — &lsquo;cash for car&rsquo; schemes use AMAP. Often more tax-efficient for low-mileage drivers." },
