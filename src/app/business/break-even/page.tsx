    ...
    <CalculatorShell
      ...
      explainer={
        <BlueprintExplainer
          ...
          officialRules={
            <ul>
              <li>Fixed costs don&rsquo;t scale with sales (rent, salaries, software).</li>
          ...
          pitfalls={[
            { title: "Your own salary is a fixed cost", body: "If you&rsquo;re a sole trader paying yourself £30k, include it. Otherwise the calculator says you&rsquo;ve broken even when you actually haven&rsquo;t paid yourself a penny." },
            { title: "Variable cost &lt; price (or you&rsquo;re doomed)", body: "If shipping + materials + payment fees exceed sale price, no volume helps. Fix the unit economics first." },
            { title: "Break-even ignores growth, taxes, capex", body: "It&rsquo;s a survival number — not a target. Aim well above to actually build a business." },
          ]}
          faqs={[
            ...
            { question: "How do I know my fixed vs variable split?", answer: "Look at last year&rsquo;s P&L. Any cost line that didn&rsquo;t change much month-on-month, regardless of sales, is fixed." },
          ]}
