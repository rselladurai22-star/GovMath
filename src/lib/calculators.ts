...
export const CALCULATORS: Calculator[] = [
  ...
  cs("tax-code-decoder", "tax-and-salary", "Tax Code Decoder", "What does 1257L, BR or NT actually mean on your payslip?"),
  ...
  cs("council-tax-bands", "property", "Council Tax Bands Lookup", "Find your band and typical bill by postcode."),
  ...
  cs("moving-house-budget", "property", "Moving House Budget", "Surveys, legal fees, removals — the full picture."),
  ...
  cs("allowable-expenses", "business", "Allowable Expenses Checker", "Quick check on what's actually deductible."),
  ...
  cs("small-business-rates", "business", "Small Business Rates Relief", "Check business-rates eligibility by rateable value."),
  ...
  cs("state-pension-age", "investing", "State Pension Age Lookup", "When can you claim your State Pension?", true),
  ...
  cs("premium-bonds", "investing", "Premium Bonds Return", "Expected vs guaranteed savings returns."),
  ...
  cs("shared-parental-leave", "benefits", "Shared Parental Leave", "Split leave and pay between two parents."),
  live("tax-free-childcare", "benefits", "Tax-Free Childcare Calculator", "Up to £2,000/year per child top-up — see your match."),
  cs("free-childcare-hours", "benefits", "Free Childcare Hours Checker", "15 or 30 free hours — eligibility by age and income."),
  ...
  cs("pension-credit", "benefits", "Pension Credit Estimator", "Top-up for low-income pensioners."),
  cs("attendance-allowance", "benefits", "Attendance Allowance", "Help with care costs for over-65s."),
  cs("benefit-cap", "benefits", "Benefit Cap Checker", "Is your household above the cumulative cap?"),
  cs("local-housing-allowance", "benefits", "Local Housing Allowance", "LHA rates by property size and region."),
  ...
  cs("commuter-comparison", "vehicles", "Commuter Cost Comparison", "Rail season ticket vs driving the same route."),
  cs("clean-air-zones", "vehicles", "Clean Air Zone Charge", "Daily charges in ULEZ, CAZ and similar schemes."),
  ...
  cs("maintenance-loan", "students", "Maintenance Loan Estimator", "Support based on household income.", true),
  ...
  cs("probate-fees", "life", "Probate Fees Calculator", "Application costs based on the estate."),
  cs("care-home-means-test", "life", "Care Home Means Test", "Will the state cover any of your care costs?"),
  cs("nhs-prescription-saver", "life", "NHS Prescription Saver", "Is a Prepayment Certificate cheaper for you?"),
  ...
  cs("bank-holidays", "life", "Bank Holidays Calculator", "Working days excluding bank holidays in your region."),
